...
function VerifyDashboard() {
  ...
  const [searchMode, setSearchMode] = useState<"id" | "domain" | "title">(
    "domain"
  );
  ...
  const handleVerify = useCallback(
    async (id?: string) => {
      ...
      try {
        ...
        if (!r.ok) {
          setVerifyError(d.error || `HTTP ${r.status}`);
          return;
        }
        setVerifyResult(d);
      } catch (e: unknown) {
  ...
  return (
    <div className="min-h-screen bg-base-200">
      {/* ── Navbar ─────────────────────────────────────────────────────── */}
      <div className="navbar bg-base-100/80 backdrop-blur-xl border-b border-base-300 sticky top-0 z-50">
        <div className="navbar-start">
          <Link
            href="/"
            className="btn btn-ghost text-lg font-bold tracking-tight gap-1"
          >
        ...
        <div className="navbar-end gap-2">
          ...
          >
            <span
              className={`w-1.5 h-1.5 rounded-full ${connected ? "bg-success-content animate-pulse-soft" : "bg-error-content"}`}
            />
            {connected
              ? `Chain ${status?.blockchain?.chainId}`
              : "Disconnected"}
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="bg-base-100 rounded-xl border border-base-300 p-3 mb-6 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs">
            ...
            <div className="flex items-center gap-1 text-base-content/50">
              ...
              <span className="font-mono text-[0.7rem]">
                {contractAddr ? truncHash(contractAddr, 6) : "—"}
              </span>
              {contractAddr && (
                <button
                  className="btn btn-ghost btn-xs p-0.5"
                  onClick={() => copyText(contractAddr, "ca")}
                >
                  {copied === "ca" ? (
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-base-100 border border-base-300 rounded-xl p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Globe size={16} className="text-secondary/60" />
                </div>
              ...
              <div className="bg-base-100 border border-base-300 rounded-xl p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Box size={16} className="text-success/60" />
                </div>
                <div
                  className={`text-xl font-bold ${connected ? "text-success" : "text-error"}`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-base-100 border border-base-300 rounded-xl p-5">
                <h2 className="font-semibold text-sm flex items-center gap-2 mb-2">
                  <Plus size={16} className="text-primary" /> Anchor a URL
                </h2>
                <p className="text-xs text-base-content/50 mb-4 leading-relaxed">
                  Directly submit a website URL to hash its content and
                  anchor it on the blockchain.
                </p>
                <button
                  className="btn btn-primary btn-sm gap-1"
                  onClick={() => setActiveTab("anchor")}
                >
                  Go to Anchor <ExternalLink size={11} />
                </button>
              </div>

              <div className="bg-base-100 border border-base-300 rounded-xl p-5">
                <h2 className="font-semibold text-sm flex items-center gap-2 mb-2">
                  <ShieldCheck size={16} className="text-success" /> Verify
                  a Proof
                </h2>
                <p className="text-xs text-base-content/50 mb-4 leading-relaxed">
                  Enter a proof ID to verify archived content against the
                  blockchain record.
                </p>
                <button
                ...
                >
                  Go to Verify <ExternalLink size={11} />
                </button>
              </div>
            </div>
            ...
            <div className="bg-base-100 border border-base-300 rounded-xl">
              <div className="p-5 pb-3 flex items-center justify-between">
                <h2 className="font-semibold text-sm flex items-center gap-2">
                  <Clock size={14} className="text-info" /> Recent Archives
                </h2>
                <button
              ...
              {recordsLoading ? (
                <div className="flex items-center justify-center py-10 text-base-content/30 gap-2 text-sm">
                ...
                <div className="text-center py-10 text-base-content/30">
                  ...
                  />
                  <p className="text-sm">
                    No archives yet. Anchor a URL or archive a search result
                    to get started.
                  </p>
                </div>
              ) : (
          ...
          <div className="animate-fadeIn space-y-6">
            <div>
              <h1 className="text-2xl font-bold flex items-center gap-2">
                <Plus size={22} className="text-primary" /> Anchor a URL to
                Blockchain
              </h1>
              <p className="text-sm text-base-content/50 mt-1">
                Enter any website URL. Its content will be fetched, hashed,
                and permanently anchored to the blockchain.
              </p>
            </div>
            ...
            <div className="bg-base-100 border border-base-300 rounded-xl p-5">
              ...
              <p className="text-xs text-base-content/30 mt-2">
                The page HTML will be fetched, hashed, and stored on-chain
                with a content snapshot.
              </p>
                ...
                <div className="mt-5 space-y-4 animate-fadeIn">
                  <div role="alert" className="alert alert-success">
                    ...
                    <div>
                      ...
                      <p className="text-xs">
                        Content archived and written to blockchain in block
                  ...
                  <div className="space-y-2">
                    {[
                      {
                        label: "TX Hash",
                        value: anchorResult.txHash,
                        key: "atx",
                      },
                      {
                        label: "Query Hash",
                        value: anchorResult.queryHash,
                        key: "aqh",
                      },
                      {
                        label: "Merkle Root",
                        value: anchorResult.merkleRoot,
                        key: "amr",
                      },
                      {
                        label: "Content CID",
                        value: anchorResult.ipfsCID,
                        key: "acid",
                      },
                    ].map((f) => (
                      <div
                      ...
                      >
                        <span className="text-xs font-medium text-base-content/40 uppercase tracking-wider w-28 shrink-0">
                          {f.label}
                        </span>
                        <code className="text-xs font-mono text-base-content/60 truncate flex-1 mx-2">
                          {f.value}
                        </code>
                        <button
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      className="btn btn-success btn-sm gap-1"
                      onClick={() => {
                        setVerifyInput(String(anchorResult.proofId));
                        handleVerify(String(anchorResult.proofId));
                      }}
                    >
        ...
        {activeTab === "verify" && (
          <div className="animate-fadeIn space-y-6">
            <div>
              <h1 className="text-2xl font-bold flex items-center gap-2">
                <ShieldCheck size={22} className="text-success" /> Verify
                Search Proof
              </h1>
              <p className="text-sm text-base-content/50 mt-1">
                Enter a proof ID to verify archived search results against
                their on-chain record.
              </p>
            </div>
            ...
            >
              ...
              <button
                type="submit"
                className="btn btn-success join-item gap-1"
            ...
            {/* Verify Result */}
            {verifyResult && (
              <div className="bg-base-100 border border-base-300 rounded-xl overflow-hidden animate-fadeIn">
                {/* Status Banner */}
                <div
                  className={`p-5 flex items-center gap-3 ${verifyResult.verified ? "bg-success/8 border-b-2 border-success" : "bg-error/8 border-b-2 border-error"}`}
                >
                  ...
                  <div>
                    <div
                      className={`font-bold text-lg ${verifyResult.verified ? "text-success" : "text-error"}`}
                    >
                      {verifyResult.verified
                        ? "✓ Verification Passed"
                        : "✗ Verification Failed"}
                ...
                <div className="p-5 border-b border-base-300">
                  <h3 className="font-semibold text-sm flex items-center gap-1.5 mb-4">
                    ...
                    On-Chain Record (Proof #{verifyResult.proofId})
                  </h3>

                  <div className="space-y-3">
                    {/* Query Hash */}
                    <div>
                      <div className="text-[0.65rem] uppercase tracking-wider text-base-content/35 font-medium mb-0.5">
                        Query Hash
                      </div>
                      <div className="flex items-center gap-2 flex-wrap">
                        <code className="text-xs font-mono text-base-content/60 break-all">
                          {verifyResult.onChain.queryHash}
                        </code>
                        <button
                          className="btn btn-ghost btn-xs p-0.5"
                          onClick={() =>
                        ...
                        <span
                          className={`badge badge-xs ${verifyResult.recomputed.queryHashMatch ? "badge-success" : "badge-error"}`}
                        >
                          {verifyResult.recomputed.queryHashMatch
                            ? "✓ Match"
                            : "✗ Mismatch"}
                        </span>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        <code className="text-xs font-mono text-base-content/60 break-all">
                          {verifyResult.onChain.resultHash}
                        </code>
                        <button
                          className="btn btn-ghost btn-xs p-0.5"
                          onClick={() =>
                        ...
                        <span
                          className={`badge badge-xs ${verifyResult.recomputed.merkleRootMatch ? "badge-success" : "badge-error"}`}
                        >
                          {verifyResult.recomputed.merkleRootMatch
                            ? "✓ Match"
                            : "✗ Mismatch"}
                        </span>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-2">
                      <div>
                        <div className="text-[0.65rem] uppercase tracking-wider text-base-content/35 font-medium mb-0.5 flex items-center gap-1">
                          <Clock size={10} /> Timestamp
                        </div>
                        <span className="text-sm">
                          {fmtDate(verifyResult.onChain.recordedAt)}
                        </span>
                      </div>
                      <div>
                        <div className="text-[0.65rem] uppercase tracking-wider text-base-content/35 font-medium mb-0.5">
                        ...
                        <code className="text-xs font-mono">
                          {truncHash(verifyResult.onChain.submitter, 6)}
                        </code>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-5 border-b border-base-300">
                  <h3 className="font-semibold text-sm flex items-center gap-1.5 mb-3">
                    <FileText size={14} className="text-info" /> Archived
                    Content
                  </h3>
                  {verifyResult.ipfs.available ? (
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <span className="text-sm">
                          {verifyResult.ipfs.archivedAt
                            ? fmtDate(verifyResult.ipfs.archivedAt)
                            : "—"}
                        </span>
                      </div>
                    </div>
                  ) : (
                    <div className="bg-base-200 rounded-lg p-3 text-sm text-base-content/40">
                      Content store not reachable — content can still be
                      verified if re-uploaded with same CID.
                    </div>
                  )}
                </div>
                ...
                {verifyResult.results.length > 0 && (
                  <div className="p-5">
                    <h3 className="font-semibold text-sm flex items-center gap-1.5 mb-3">
                      ...
                      Archived Results ({verifyResult.results.length})
                    </h3>
                    <div className="space-y-2">
                      {verifyResult.results.map((r, i) => (
                        ...
                        >
                          ...
                          <div className="collapse-title text-sm font-medium flex items-center gap-2 pr-8">
                            <span
                              className={`w-2 h-2 rounded-full shrink-0 ${r.hashMatch ? "bg-success shadow-sm shadow-success/40" : "bg-error shadow-sm shadow-error/40"}`}
                            />
                            ...
                            {r.hasPageSnapshot && (
                              <span className="badge badge-xs badge-info">
                                {(r.pageSnapshotSize / 1024).toFixed(
                                  1
                                )}{" "}
                                KB
                              </span>
                          ...
                          <div className="collapse-content space-y-2">
                            <div>
                              <span className="text-[0.65rem] uppercase text-base-content/35 font-medium">
                                URL
                              </span>
                              <a
                                href={r.url}
                            ...
                            <div>
                              ...
                              <code className="block text-[0.65rem] font-mono text-base-content/50">
                                {r.contentHash}
                              </code>
                            </div>
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                <code className="text-[0.65rem] font-mono text-base-content/50">
                                  {r.recomputedHash}
                                </code>
                                <span
                                  className={`badge badge-xs ${r.hashMatch ? "badge-success" : "badge-error"}`}
                                >
                                  {r.hashMatch ? "✓" : "✗"}
                                </span>
                              </div>
          ...
          <div className="animate-fadeIn space-y-6">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                ...
                <p className="text-sm text-base-content/50 mt-1">
                  All search archive records on Chain{" "}
                  {status?.blockchain?.chainId || 31337}.
                </p>
              </div>
              <button
            ...
            <div className="join w-full">
              <div className="dropdown">
                <button
                  tabIndex={0}
                  className="btn join-item btn-neutral gap-1"
                >
                  <Filter size={13} />
                ...
                <ul
                  tabIndex={0}
                  className="dropdown-content menu bg-base-200 rounded-box z-10 w-44 p-2 shadow-lg border border-base-300"
                >
                  <li>
                    <button
                      onClick={() => setSearchMode("id")}
                      className={
                        searchMode === "id" ? "active" : ""
                      }
                    >
      ...
      {/* ── Footer ──────────────────────────────────────────────────── */}
      <footer className="border-t border-base-300 bg-base-100/50 mt-auto">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between text-xs text-base-content/30">
          <span>SearchX Verification Portal</span>
          <span>
            Hardhat Local Testnet · Chain{" "}
            {status?.blockchain?.chainId || 31337}
          </span>
        </div>
      </footer>
